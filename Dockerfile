...
RUN /bin/bash -c "git checkout fc7fb11ccec407753a73ab810d1dbb5f57d0f9b9; conda activate habitat; cd habitat-sim; pip install -r requirements.txt; python setup.py install --headless"

# Install challenge specific habitat-lab
RUN git clone --branch stable https://github.com/facebookresearch/habitat-lab.git
RUN /bin/bash -c "git checkout bc85d0961cef3b4a08bc9263869606109fb6ff0a; conda activate habitat; cd habitat-lab; pip install -e habitat-lab/"
